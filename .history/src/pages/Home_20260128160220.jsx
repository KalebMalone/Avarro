                ...
                <div className="max-w-5xl mx-auto px-6 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                Defining every lawn, driveway, and flower bed with a crisp, clean vertical line.
                            </p>
                        </div>
                        <div className="p-6">
                            ...
                            <p className="text-gray-600 leading-relaxed">
                                We clear all debris from your hard surfaces, leaving your property spotless.
                            </p>
                        </div>
                    </div>
