        ...
        <div className="bg-white">
            ...
            <section className="py-20 px-6">
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="relative">
                        <div className="aspect-square rounded-2xl bg-gray-200 overflow-hidden shadow-2xl border-8 border-white">
                            {/* Replace this URL with a photo of you or your truck/mower later! */}
                            <img 
                                src="https://images.pexels.com/photos/1474416/pexels-photo-1474416.jpeg?auto=compress&cs=tinysrgb&w=800" 
                                alt="Avarro Landscaping Work" 
                    ...
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-3xl font-bold text-[#1a4332] mb-4">Local. Driven. Detailed.</h2>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-[#94a84a]">
                            <h4 className="font-bold text-[#1a4332] mb-2 italic">"We treat every yard as if it were our own."</h4>
                            <p className="text-gray-600 text-sm italic">— The Avarro Mission</p>
                        </div>

                        <div className="space-y-4">
                            <h3 className="text-xl font-bold text-[#1a4332]">Why choose a new local business?</h3>
            ...
            <section className="py-20 bg-[#1a4332] text-white">
                <div className="max-w-5xl mx-auto px-6 text-center">
                    <h2 className="text-3xl font-bold mb-12">The Three Pillars of Avarro</h2>
