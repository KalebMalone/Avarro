    ...
    return (
        <div className="bg-white">
            {/* FIXED INFINITE BANNER 
                Note: top-[64px] pushes it below a standard Navbar. 
                If your nav is taller, change this number (e.g., top-[80px]).
            */}
            ...
            {/* Added a larger spacer so the banner doesn't hide the top of the Hero */}
