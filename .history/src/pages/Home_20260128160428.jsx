                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="p-4">
                            ...
                            <p className="text-gray-600 text-sm leading-relaxed">
                                Professional-grade equipment set to the perfect height for your lawn.
                            </p>
                        </div>
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-gray-600 text-sm leading-relaxed">
                                Defining lawns, walkways and beds with crisp, clean vertical lines.
                            </p>
                        </div>
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-gray-600 text-sm leading-relaxed">
                                Targeted weed removal in beds and cracks to keep the property looking nice and fresh.
                            </p>
                        </div>
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-gray-600 text-sm leading-relaxed">
                                High-velocity clearing of driveways and patios so it's spotless when we leave.
                            </p>
                        </div>
                    </div>
