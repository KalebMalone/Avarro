...
export default function Hero() {
    return (
        <section className="h-[90vh] bg-[url('https://images.unsplash.com/photo-1603993097397-89e41fdbf1c0?auto=format&fit=crop&w=1950&q=80')] bg-cover bg-center -mt-32 md:-mt-20">
