...
export default function Hero() {
    return (
        <section className="relative h-[80vh] bg-[url('https://images.pexels.com/photos/5502221/pexels-photo-5502221.jpeg')] bg-cover bg-[position:center_bottom] bg-no-repeat -mt-32 md:-mt-20">
