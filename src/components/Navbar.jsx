        ...
        <nav className="fixed top-0 left-0 w-full h-20 bg-white shadow-md z-[100] flex items-center">
            <div className="max-w-7xl mx-auto px-4 w-full flex items-center justify-between">
                ...
                <div className="flex space-x-3 sm:space-x-8 font-semibold text-gray-700 text-sm sm:text-base">
                    <Link to="/services" className="no-underline hover:text-[#1a4332] transition">Services</Link>
                    <Link to="/about" className="no-underline hover:text-[#1a4332] transition">About</Link>
                    <Link to="/contact" className="no-underline hover:text-[#1a4332] transition">Contact</Link>
                </div>
            </div>
        </nav>
    );
