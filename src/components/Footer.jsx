        ...
        <footer className="bg-[#1a4332] text-white pt-20 pb-10 px-6">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-16">
                <div className="col-span-1 md:col-span-1">
                    <h3 className="text-2xl font-bold mb-4 italic">PRECISION LANDSCAPE</h3>
                ...
                <div>
                    ...
                    <ul className="text-gray-400 text-sm space-y-2">
                        ...
                        <li>
                            <Link to="/about" className="hover:text-white transition no-underline">The Precision Story</Link>
                        </li>
                        <li>
