export default function Footer() {
    return (
        <footer className="bg-[#1a4332] text-white pt-20 pb-10 px-6">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 border-b border-white/10 pb-16">
                ...
                <div>
                    ...
                    <ul className="text-gray-400 text-sm space-y-2">
                        ...
                        <li><a href="/about" className="hover:text-white transition">The Avarro Story</a></li>
                        <li><a href="/contact" className="hover:text-white transition">Apply for 2026 Season</a></li>
                    </ul>
                </div>
            ...
            <div className="max-w-6xl mx-auto pt-10 flex flex-col md:row justify-between items-center text-gray-500 text-xs">
